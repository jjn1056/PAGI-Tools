...
Routing deliberately ignores lifespan scopes. Compose lifecycle policy around
the immutable object; L<PAGI::Lifespan> uses C<PAGI::Utils::to_app> and compiles
it once:
