...
=head2 1.1 How Middleware Works
...
L</1.3 Essential Middleware Reference>) rather than writing your own.
...
middleware list (see L</1.2 Using Middleware with Builder>).
...
=head2 1.2 Using Middleware with Builder
...
=head2 1.3 Essential Middleware Reference
...
=head2 1.4 Writing Custom Middleware
...
=head1 PART 2: THE HELPER CLASSES

In the protocol tutorial (see L<PAGI::Tutorial>), we worked directly with the raw PAGI protocol (C<$scope>, C<$receive>, C<$send>). While powerful, this low-level approach requires a lot of boilerplate code for common tasks.
...
=head2 2.1 PAGI::Response - Fluent Response Builder
...
=head2 2.2 PAGI::Request - Request Parsing
...
=head2 2.3 PAGI::WebSocket - WebSocket Helper
...
=head2 2.4 PAGI::SSE - Server-Sent Events Helper
...
=head2 3.2 PAGI::App::File - Static Files
...
=head2 3.3 PAGI::App::Healthcheck - Health Endpoints
...
=head2 3.4 PAGI::App::URLMap - Mount Applications
...
=head2 3.5 PAGI::App::Cascade - Try Apps in Sequence
...
=head2 3.6 PAGI::App::Proxy - Reverse Proxy
...
=head2 3.7 PAGI::App::WrapPSGI - Use Existing PSGI Apps
...
L<PAGI::App::Router> accept instances or
C<($scope, $receive, $send, $next)> coderefs.
