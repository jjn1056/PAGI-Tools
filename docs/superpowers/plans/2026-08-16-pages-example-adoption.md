...
- [x] **Step 1: Write failing declarative-routing expectations**
...
- [x] **Step 2: Verify the declarative test fails for the expected old JSON shape**
...
- [x] **Step 3: Implement the declarative handlers with Pages**
...
- [x] **Step 6: Verify the Endpoint Router test fails for missing Pages behavior**
...
- [x] **Step 7: Implement Endpoint Router responses with Pages**
...
- [x] **Step 8: Verify and document the Endpoint Router behavior**
...
- [x] **Step 1: Write a failing endpoint-demo 415 expectation**
...
- [x] **Step 2: Verify the endpoint-demo test fails for the old payload**
...
- [x] **Step 3: Implement and document the endpoint-demo response**
...
- [x] **Step 4: Verify endpoint-demo**

  Run: `prove -lv t/integration-app-file-examples.t`

  Expected: PASS.

- [x] **Step 5: Create a failing lifespan-utils integration test**
...
- [x] **Step 6: Verify the lifespan-utils test fails for the placeholder response**

  Run: `prove -lv t/integration-lifespan-utils-example.t`

  Expected: FAIL because the current body is only `Hello from PAGI!`.

- [x] **Step 7: Implement and document the lifespan welcome response**
...
- [x] **Step 8: Verify the lifespan-utils example**
...
- [x] **Step 1: Write failing API-not-found expectations**
...
- [x] **Step 2: Verify the v2 chat test fails for the old JSON schema**
...
- [x] **Step 3: Implement Pages-backed API misses**
...
- [x] **Step 4: Verify and document the v2 chat behavior**
...
- [x] **Step 1: Run the focused integration set**
...
- [x] **Step 3: Run the complete suite once**
...
- [x] **Step 5: Commit any final test/documentation corrections**
